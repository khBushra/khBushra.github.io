# Dr. Bushra Khalid – Academic & Professional Portfolio

Welcome to the official academic and professional website of Dr. Bushra Khalid.
...
- Water–Energy–Land Systems
- Remote Sensing and Geospatial Analytics
- Environmental and Climate Data Analysis
- Disaster Risk Reduction and Climate Risk Assessment

## Technical Expertise
- Climate Modeling (RegCM)
- Remote Sensing Applications (MODIS, NDVI)
- GIS & Geospatial Analytics (ArcGIS, ERDAS, Google Earth Engine)
- Python-based Data Analysis
- Statistical Analysis (SPSS, XLSTAT, Minitab)

## Professional Activities
This website highlights:
- Research publications
- Climate and GIS projects
- Professional training activities
- International collaborations
- Workshops and academic engagements
- Climate and disaster management initiatives
...
- Reviewer and editorial contributor
- Organizer of climate change and remote sensing workshops
- Contributor to interdisciplinary climate resilience initiatives
